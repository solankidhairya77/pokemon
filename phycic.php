...
<body style="background-color:rgb(223, 168, 220)">         
    <div class="container">
        <div class="col-sm-12 cbox">
            <div class="row rbox">
                <?php
                    include "connect.php";
                    $sql="SELECT * FROM `data` WHERE `type`='phycic' or `type2` = 'phycic'";
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          <!-- <img src="./dataimg/<?php echo $data['image']; ?>"  style="height:100px;"> -->
                                          <pre>type = <?php echo $data['type']?> <?php echo $data['type2']?></pre>
                                        </div>
                                    </div>
                                </div>
                            </div>
